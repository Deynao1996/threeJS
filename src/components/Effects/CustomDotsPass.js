...
const DotScreenShader = {
  ...
  fragmentShader: /* glsl */ `
    ...
    // Mix final noise value
      ...
      float holoIntensity = 0.5 + 0.1 * snoise(vec3(0., 10., uTime));

      float direction = mod(vUv.y * 1000. + uTime * 0.05, 4.) < 2. ? 1. : -1.;
      ...
      vec3 theLastColor = mix(color.rgb, finalColor, progress);

			gl_FragColor = vec4(theLastColor, 1.);
		}`
}
