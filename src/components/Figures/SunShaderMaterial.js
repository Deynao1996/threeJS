import { CubeCamera, OrbitControls, shaderMaterial } from "@react-three/drei"
import { extend, useFrame, useLoader, useThree } from "@react-three/fiber"
import glsl from "babel-plugin-glsl/macro"
import { useRef } from "react"
import * as THREE from 'three'

const PerlinShaderMaterial = shaderMaterial(
  {
    uTime: 0,
    uProgress: 0.0,
...
const AroundShaderMaterial = shaderMaterial(
  {
    uTime: 0,
    uProgress: 0.0,
    uImage: new THREE.Texture(),
